...
*  	Web Intelligence - Please like us on facebook http://www.facebook.com/webintelligence.ie
*	http://www.webintelligence.ie
*
*	Current maintainer: MSc. Eng. Nestor Alonso Torres :: <nalonso@engineer.com>
*/
...
function whoviewedme_init() {
    ...
    // add a blog widget
    elgg_register_widget_type('whoviewedme', elgg_echo('whoviewedme:whoviewedthisprofile'), elgg_echo('whoviewedme:widget:description'));
}
